...
document.getElementById("player_question").innerHTML= "Turno de quien pregunta (hazlo rapido):D" + player1_name;
document.getElementById("player_answer").innerHTML= "Turno de quien responde (hazlo bien o mueres):D" + player2_name;


function send() {
get_word=document.getElementById("word").value;
word=get_word.toLowerCase();
console.log("palabra hecha en minusculas= " + word);
...
question_word="<h4 id='word_display'> Palabra para adivinar: " + remove_chartAt3 + "</h4>";
input_box="<br> Respuesta: <input type='text' id='input_check_box'>";
check_button="<br><br><button class='btn btn-info' onclick='check()'> Comprueba tu palabra para no morir</button>";
